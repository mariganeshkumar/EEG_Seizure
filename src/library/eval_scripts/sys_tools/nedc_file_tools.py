...
def load_parameters(pfile_a, keyword_a):
    ...
    for line in fp:
        ...
        elif ((str.startswith(keyword_a) == True) and (DELIM_BOPEN in str)):
            flag_pblock = True
...
#
def get_dirs(flist, odir=DELIM_NULL, rdir=DELIM_NULL):
    ...
    for fname in flist:
        ...
        #
        ofile = make_ofile(fname, DELIM_NULL, odir, rdir)
...
def get_fullpath(path_a):
    return os.path.abspath(os.path.expanduser(os.path.expandvars(path_a)))
#
# end of function
